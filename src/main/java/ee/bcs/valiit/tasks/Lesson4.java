...
//Siit alates on Postmani harjutamine pangakontoga!!!_______________
public class Lesson4 {
    public static Map<String, Double> accountBalanceMap = new HashMap<String, Double>();
...
//        }
//    }
// siit edasi on kontrolleri jaoks loodud uus kood____________________________________________________
//GetMapping meetod
    public static String createAccount(String accountNr, double initialBalance) {
        accountBalanceMap.put(accountNr, initialBalance);
        return "Your new account is " + accountNr + " .";
    }
    ...
    public static String deposit(String accountNr, double deposit) {
        double balance = accountBalanceMap.get(accountNr);
        if (deposit < 0) {
        ...
        return "Your new balance is " + accountBalanceMap.get(accountNr);
    }

    public static String withdraw(String accountNr, double withdraw) {
        double balance = accountBalanceMap.get(accountNr);
        if (withdraw < 0) {
            return "Amount must be positive value!";
    ...
    public static String transfer(String fromAccount, String toAccount, double amount) {
